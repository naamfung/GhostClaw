...
<ScrollArea class="h-[100vh]">
        <Sidebar.Header class=" top-0 z-10 gap-6 bg-sidebar/50 px-4 py-4 pb-2 backdrop-blur-lg md:sticky">
                <a href="#/" onclick={handleMobileSidebarItemClick}>
                        <h1 class="inline-flex items-center gap-1 px-2 text-xl font-semibold">GhostClaw</h1>
                </a>
...
<DialogConfirmation
        ...
        description={selectedConversation
                ? `确定要删除 "${selectedConversationNamePreview}" 吗？此操作无法撤销，将永久删除该对话中的所有消息。`
                : ''}
        confirmText="删除"
        cancelText="取消"
        variant="destructive"
...
<AlertDialog.Root bind:open={showEditDialog}>
        <AlertDialog.Content>
                <AlertDialog.Header>
                        <AlertDialog.Title>编辑对话名称</AlertDialog.Title>
                ...
                <AlertDialog.Footer>
                        ...
                        >
                        <AlertDialog.Action onclick={handleConfirmEdit}>保存</AlertDialog.Action>
                </AlertDialog.Footer>
        </AlertDialog.Content>
</AlertDialog.Root>
