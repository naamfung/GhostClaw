...
export class GhostClawChatService {
        ...
        static async sendMessage(
                ...
                return new Promise((resolve, reject) => {
                        // Capture whether the message has been sent to avoid double-send race condition
                        // Bug: previously both onStatusChange('connected') and the getStatus() check
                        // below could fire, causing the same message to be sent twice
