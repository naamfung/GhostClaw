...
<div
        ...
        style="max-height: {maxHeight}; max-width: {maxWidth}; overflow-x: hidden;"
>
        <!-- Needs to be formatted as single line for proper rendering -->
        <pre class="m-0 overflow-y-auto"><code class="hljs text-sm leading-relaxed">{@html highlightedHtml}</code></pre>
</div>
