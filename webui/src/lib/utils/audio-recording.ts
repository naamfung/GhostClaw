...
export class AudioRecorder {
        ...
        async startRecording(): Promise<void> {
                try {
                        ...
                        if (!this.mediaRecorder) {
                                throw new Error('Failed to initialize audio recorder. Your browser may not support audio recording.');
                        }
        ...
        private initializeRecorder(stream: MediaStream): void {
                ...
                try {
                        ...
                        console.warn('Failed to create MediaRecorder with preferred options, trying without mimeType:', error);
                        try {
