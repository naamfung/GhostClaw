...
<!--
  This is a single file build of the GhostClaw frontend.
...
function ghostclawBuildPlugin() {
        return {
                name: 'ghostclaw:build',
                ...
                closeBundle() {
                        ...
                        setTimeout(() => {
                                try {
                                        ...
                                        // For ghostclaw, we keep the uncompressed HTML for Go embed
...
export default defineConfig({
        ...
        plugins: [tailwindcss(), sveltekit(), devtoolsJson(), ghostclawBuildPlugin()],
