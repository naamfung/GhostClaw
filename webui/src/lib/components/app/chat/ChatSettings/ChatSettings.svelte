<script lang="ts">
        ...
        let showFooter = $derived(
                activeSection !== SETTINGS_SECTION_TITLES.MODEL &&
                activeSection !== SETTINGS_SECTION_TITLES.ROLES &&
                activeSection !== SETTINGS_SECTION_TITLES.SKILLS &&
                activeSection !== SETTINGS_SECTION_TITLES.ACTORS
        );
...
<div class="flex h-full flex-col overflow-hidden md:flex-row">
        <!-- Desktop Sidebar -->
        <div class="hidden w-52 flex-shrink-0 border-r border-border/30 p-4 md:flex md:flex-col">
